defmodule SmarterRandomAdmiral do
  ...
  def fire(_enemy_board, previous_shots, _shot_results, _state) do
    get_random_available_coordinate(previous_shots)
  end
  ...
  defp get_random_available_coordinate(previous_shots) do
    columns = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"]
    rows = 1..10
    ...
    |> List.flatten()
    |> Enum.reject(&(&1 in previous_shots))
    |> Enum.random
  end
